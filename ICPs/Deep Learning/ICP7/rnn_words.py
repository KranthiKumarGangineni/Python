...
data = pandas.read_csv('data/trainingandtestdata/testdata.manual.2009.06.14.csv', sep=',', header=1, usecols=[5])
csvData = data.values
print(csvData[1][0])

with open('sentimentanalysis.txt', 'w') as f:
    f.write(csvData[1][0])
...
training_file = 'sentimentanalysis.txt'
